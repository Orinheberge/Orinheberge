...
<head>
  ...
  <title><?php echo t('cgu.title'); ?></title>
...
<main class="flex-grow flex items-center justify-center p-6 my-8">
  <div class="w-full max-w-4xl glass p-8 rounded-3xl shadow-2xl space-y-6">
    <div class="text-center mb-4">
      <h1 class="text-3xl font-black gradient-text uppercase tracking-tighter mb-2"><?php echo t('cgu.heading'); ?></h1>
      <p class="text-gray-400 text-sm"><?php echo t('cgu.subtitle'); ?></p>
    </div>

    <div class="space-y-4 text-sm text-gray-300 leading-relaxed max-h-[50vh] overflow-y-auto pr-2">
      <section class="bg-white/[0.01] p-5 rounded-2xl border border-white/5">
        <h2 class="text-base font-bold text-white mb-2"><?php echo t('cgu.s1.title'); ?></h2>
        <p><?php echo t('cgu.s1.text'); ?></p>
      </section>
      <section class="bg-white/[0.01] p-5 rounded-2xl border border-white/5">
        <h2 class="text-base font-bold text-white mb-2"><?php echo t('cgu.s2.title'); ?></h2>
        <p><?php echo t('cgu.s2.text'); ?></p>
      </section>
      <section class="bg-white/[0.01] p-5 rounded-2xl border border-white/5">
        <h2 class="text-base font-bold text-white mb-2"><?php echo t('cgu.s3.title'); ?></h2>
        <p><?php echo t('cgu.s3.text'); ?></p>
      </section>
      <section class="bg-white/[0.01] p-5 rounded-2xl border border-white/5">
        <h2 class="text-base font-bold text-white mb-2"><?php echo t('cgu.s4.title'); ?></h2>
        <p><?php echo t('cgu.s4.text'); ?></p>
      </section>
    </div>
