...
<head>
    ...
    <title>OrinHeberge | <?php echo t('hero.title'); ?></title>
    ...
    <meta name="keywords" content="hébergement, minecraft, vps, nodejs, php, serveur">
...
<main class="flex-grow">
    <!-- Hero -->
    <header class="text-center py-24 md:py-32 px-6 relative overflow-hidden">
        ...
        <h2 class="text-5xl md:text-8xl font-black tracking-tight leading-none">
            <?php echo t('hero.title'); ?>
        </h2>
        <p class="text-gray-400 mt-6 max-w-xl mx-auto text-lg"><?php echo t('hero.subtitle'); ?></p>

        <div class="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
            <a href="#offres-gratuites" class="w-full sm:w-auto bg-sky-600 hover:bg-sky-500 text-white px-8 py-3.5 rounded-xl font-bold transition shadow-lg shadow-sky-900/30">
                <?php echo t('hero.cta'); ?>
            </a>
            <div class="glass px-5 py-3.5 rounded-xl flex items-center text-sm border border-white/10 w-full sm:w-auto justify-center">
                <span class="h-2.5 w-2.5 rounded-full mr-3 animate-pulse <?php echo $db_status ? 'bg-green-400 shadow-lg shadow-green-400/50' : 'bg-red-500 shadow-lg shadow-red-500/50'; ?>"></span>
                <?php echo $db_status ? t('hero.status_ok') : t('hero.status_ko'); ?>
            </div>
        </div>
    </header>

    <!-- About -->
    <section id="a-propos" class="py-12 px-6 max-w-7xl mx-auto">
        <div class="glass rounded-3xl p-8 md:p-12 border border-white/5 relative overflow-hidden flex flex-col lg:flex-row items-center gap-12">
            <div class="absolute -right-16 -top-16 w-64 h-64 bg-sky-500/5 rounded-full blur-3xl pointer-events-none"></div>
            <div class="absolute -left-16 -bottom-16 w-64 h-64 bg-purple-500/5 rounded-full blur-3xl pointer-events-none"></div>

            <div class="lg:w-1/2">
                <div class="inline-flex items-center gap-2 bg-sky-500/10 text-sky-400 border border-sky-500/20 px-3 py-1 rounded-full text-xs font-semibold mb-4">
                    <i class="fas fa-info-circle"></i> <?php echo t('about.badge'); ?>
                </div>
                <h2 class="text-3xl md:text-4xl font-black mb-6"><?php echo t('about.title'); ?> <span class="gradient-text">OrinHeberge</span> ?</h2>
                <p class="text-gray-400 leading-relaxed mb-6"><?php echo th('about.p1'); ?></p>
                <p class="text-gray-400 leading-relaxed"><?php echo t('about.p2'); ?></p>
            </div>

            <div class="lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                <div class="glass p-6 rounded-2xl border border-white/5 hover:bg-white/[0.05] transition">
                    <i class="fas fa-microchip text-sky-400 text-2xl mb-3"></i>
                    <h4 class="font-bold text-white mb-1"><?php echo t('about.feat1_title'); ?></h4>
                    <p class="text-gray-400 text-xs leading-relaxed"><?php echo t('about.feat1_desc'); ?></p>
                </div>
                <div class="glass p-6 rounded-2xl border border-white/5 hover:bg-white/[0.05] transition">
                    <i class="fas fa-layer-group text-purple-400 text-2xl mb-3"></i>
                    <h4 class="font-bold text-white mb-1"><?php echo t('about.feat2_title'); ?></h4>
                    <p class="text-gray-400 text-xs leading-relaxed"><?php echo t('about.feat2_desc'); ?></p>
                </div>
                <div class="glass p-6 rounded-2xl border border-white/5 hover:bg-white/[0.05] transition">
                    <i class="fas fa-hand-holding-dollar text-green-400 text-2xl mb-3"></i>
                    <h4 class="font-bold text-white mb-1"><?php echo t('about.feat3_title'); ?></h4>
                    <p class="text-gray-400 text-xs leading-relaxed"><?php echo t('about.feat3_desc'); ?></p>
                </div>
                <div class="glass p-6 rounded-2xl border border-white/5 hover:bg-white/[0.05] transition">
                    <i class="fas fa-shield-halved text-amber-400 text-2xl mb-3"></i>
                    <h4 class="font-bold text-white mb-1"><?php echo t('about.feat4_title'); ?></h4>
                    <p class="text-gray-400 text-xs leading-relaxed"><?php echo t('about.feat4_desc'); ?></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div data-category="<?php echo $cat; ?>" data-price="<?php echo $price_num; ?>"
                ...
                <div class="p-6 flex flex-col flex-grow">
                    ...
                    <ul class="space-y-3 text-gray-300 text-sm border-t border-white/5 pt-4">
                        ...
                        <li>
                            <i class="<?php echo $feat['icon'].' '.$s['icon_color']; ?> mr-2 w-4"></i><?php echo isset($feat['text_key']) ? t($feat['text_key']) : $feat['text']; ?>
                        </li>
                        <?php endforeach; ?>
                    </ul>
