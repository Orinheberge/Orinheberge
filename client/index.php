  ...
  <div class="content">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="space-y-2.5">
        ...
        <a href="/admin/" class="qlink" style="border-color:rgba(251,146,60,.2)"><div class="qlink-icon bg-orange-500/15"><i class="fas fa-shield-halved text-orange-400"></i></div><div><div class="text-xs font-semibold text-orange-400">Administration</div><div class="text-[10px] text-gray-500">Panel admin</div></div></a>
        <?php endif; ?>
      </div>
