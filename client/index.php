  ...
  <div class="content">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="space-y-2.5">
        ...
        <a href="/client/support/" class="qlink"><div class="qlink-icon bg-purple-500/15"><i class="fas fa-headset text-purple-400"></i></div><div><div class="text-xs font-semibold text-white">Support</div><div class="text-[10px] text-gray-500">Ouvrir un ticket</div></div></a>
