...
<aside id="sidebar" class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/client/" class="nav-item"><i class="fas fa-home icon"></i> Tableau de bord</a>
        <a href="/client/servers/" class="nav-item"><i class="fas fa-server icon"></i> Mes serveurs</a>
        <a href="/offres/" class="nav-item"><i class="fas fa-tags icon"></i> Nos offres</a>
        <div class="nav-separator"></div>
        <div class="nav-section">Compte</div>
        <a href="/profil/" class="nav-item"><i class="fas fa-user icon"></i> Mon profil</a>
        <a href="/client/billing/" class="nav-item active"><i class="fas fa-file-invoice-dollar icon"></i> Facturation</a>
        ...
        <a href="<?php echo htmlspecialchars($cfg['phpmyadmin_url'] ?? ''); ?>" target="_blank" class="nav-item"><i class="fas fa-database icon"></i> phpMyAdmin</a>
    </nav>
