...
$setup_intent_id = htmlspecialchars($_GET['setup_intent']);
$stripe_pub_key = htmlspecialchars(get_setting('stripe_public_key'));
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        ...
        .loader { border: 4px solid rgba(255,255,255,0.1); border-top: 4px solid #38bdf8; border-radius: 50%; width: 50px; height: 50px; animation: spin 1s linear infinite; margin-bottom: 20px; }
...
<body>
    <div style="text-align: center;">
        ...
        <p style="color: #94a3b8;">Redirection vers votre banque...</p>
    </div>
    <script>
        const stripe = Stripe('<?php echo $stripe_pub_key; ?>');
        stripe.confirmCardSetup('<?php echo $setup_intent_id; ?>')
